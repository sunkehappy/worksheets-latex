...
function main() {
  ...
  const sourcePath = path.join("dist", "worksheet_add_2digit_1digit_missing.pdf");
  ...
  execSync(`tectonic templates/worksheet_add_2digit_1digit_missing.tex --outdir=${distPath}`, { 
    stdio: "inherit"
  });
